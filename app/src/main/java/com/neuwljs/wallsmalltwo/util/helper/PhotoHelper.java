 ...
 * 3.通过{@link FragmentManager#findFragmentByTag(String)}方法并传入{@link #PHOTO_DIALOG_TAG}
...
public class PhotoHelper {
    ...
    public static final String PHOTO_DIALOG_TAG = "take_photo";
    ...
    public static void getPhoto(final FragmentManager manager, final Callback callback){
        ...
        dialog.show (manager, PHOTO_DIALOG_TAG);
    }
