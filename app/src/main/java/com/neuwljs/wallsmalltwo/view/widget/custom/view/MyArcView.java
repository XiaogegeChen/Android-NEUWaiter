package com.neuwljs.wallsmalltwo.view.widget.custom.view;
...
public class MyArcView extends View {
    ...
    public MyArcView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes (attrs, R.styleable.MyArcView);

        // 拿到属性值
        mArcHeight = typedArray.getDimensionPixelSize (R.styleable.MyArcView_arcHeight, 0);
        int mColor = typedArray.getColor (R.styleable.MyArcView_bgColor, Color.BLUE);
