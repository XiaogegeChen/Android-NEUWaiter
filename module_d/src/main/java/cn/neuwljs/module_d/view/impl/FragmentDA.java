...
import cn.neuwljs.module_d.adapter.MyPagerAdapter;
import cn.neuwljs.module_d.R;
import cn.neuwljs.widget.BannerViewPager;

import static cn.neuwljs.module_d.Constants.BANNER_INTERVAL;
...
public class FragmentDA
    ...
    public int getLayoutId() {
        return R.layout.module_d_fragment_d_a;
    }

    @Override
    public void initView(View view) {
        mBannerViewPager = view.findViewById (R.id.module_d_fragment_d_a_picture_view_pager);
        mTabLayout = view.findViewById (R.id.module_d_fragment_d_a_tab);
        mPropertyViewPager = view.findViewById (R.id.module_d_fragment_d_a_lost_and_found_view_pager);
        mFloatingActionButton = view.findViewById (R.id.module_d_fragment_d_a_fab_refresh);

        // 轮播图指示器初始化
        mBannerPointList = new ArrayList<> ();
        mBannerPointList.add (view.findViewById (R.id.module_d_fragment_d_a_banner_point_0));
        mBannerPointList.add (view.findViewById (R.id.module_d_fragment_d_a_banner_point_1));
        mBannerPointList.add (view.findViewById (R.id.module_d_fragment_d_a_banner_point_2));
        mBannerPointList.add (view.findViewById (R.id.module_d_fragment_d_a_banner_point_3));

        // 设置轮播图在第一页
        mBannerPointList.get (0).setBackground (obtainResources ().getDrawable (R.drawable.module_d_bg_fragment_d_a_banner_blue_point));
    }
    ...
    public void initData() {
        ...
        mBitmapList.add (BitmapFactory.decodeResource (obtainResources (), R.drawable.module_d_test_1));
        mBitmapList.add (BitmapFactory.decodeResource (obtainResources (), R.drawable.module_d_test_2));
        mBitmapList.add (BitmapFactory.decodeResource (obtainResources (), R.drawable.module_d_test_3));
        mBitmapList.add (BitmapFactory.decodeResource (obtainResources (), R.drawable.module_d_test_4));
        ...
        mBannerPageChangeListener = new MyOnPageChangeListener () {
            ...
            public void onPageSelected(int i) {
                ...
                for(int j=0;j<mBannerPointList.size ();j++){
                    if(j == i){
                        mBannerPointList.get (j).setBackground (obtainResources ().getDrawable (R.drawable.module_d_bg_fragment_d_a_banner_blue_point));
                    }else{
                        mBannerPointList.get (j).setBackground (obtainResources ().getDrawable (R.drawable.module_d_bg_fragment_d_a_banner_normal_point));
                    }
                }
        ...
        // tabLayout设置
        mTabLayoutTitles = obtainResources ().getStringArray (R.array.module_d_fragment_d_a_tab_titles);
    ...
    public void onClick(View v) {
        int id = v.getId ();
        if(id == R.id.module_d_fragment_d_a_fab_refresh){
